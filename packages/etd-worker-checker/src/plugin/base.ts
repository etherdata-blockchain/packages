...
export abstract class BasePlugin {
  ...
  protected equal(
    ...
    if (foundValue === expectValue) {
      ...
      return [
        false,
        `${errorMessage}, found ${foundValue}, expect equals to ${expectValue}`,
      ];
    }
  }
  ...
  protected greaterThan(
    ...
    if (foundValue > expectValue) {
      ...
      return [
        false,
        `${errorMessage}, found ${foundValue}, expect greater than ${expectValue}`,
      ];
    }
  }
  ...
  protected lessThan(
    ...
    if (foundValue < expectValue) {
      ...
      return [
        false,
        `${errorMessage}, found ${foundValue}, expect less than ${expectValue}`,
      ];
    }
  }
}
